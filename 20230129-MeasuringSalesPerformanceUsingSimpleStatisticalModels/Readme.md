...
There is a super simple statistical regression formula (illustrated below) that can be used. Many social sciences studies show that cognitive correlation regarding performance is usually in the 20% (0.2) - 30% (0.3) range. This means that using a job interview performance as the key driver of future sales outcomes will only likely explain 20%-30% of future sales outcomes. In fact, only 3% of 708 cognitive studies showed corelations of 50% or more on future performance from a single cognitive driver (like a job interview)[^8].
