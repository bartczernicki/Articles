...
OpenAI Deep Research is the main AI component. OpenAI Deep Research is an AI Automation Workflow. It works by refactoring the goal, spending time performing robust research using internet knowledge grounding and delivers a final comprehensive report to the user. Deep Research automation can take several minutes to complete. I have seen it take up to 25 minutes on certain research tasks.

The OpenAI Deep Research process armed with multiple steps and tool calls greatly improves accuracy of the results. This is illustrated below on the benchmark results with *Humanity's Last Exam* data set. This benchmark is meant to be a very challenging benchmark of 2,700 curated questions. As clearly seen from below, the Deep Research process greatly improves performance than individual AI models.  
...
More information on *Humanity's Last Exam* can be found here with updated results: https://agi.safe.ai/ 
...
> Cleaned up the table and statistics for consistency. Removed the minor categories.  

| Career Metric             | Tom Brady (Final Career) | Patrick Mahomes (Projected Career) |
|---------------------------|-------------------------|-----------------------------------|
| **Super Bowl Wins**       | 7 ✅ <br> (Holds Record)                   | 5 (projected) <br> *Assumes two more championships to finish with 5 total* |
| **Super Bowl MVP Awards** | 5 <br> (Holds Record)                       | 5 (projected) <br> *Likely earns MVP in most future SB wins* |
| **NFL MVP Awards**        | 3    | 4 ✅ (projected) <br> *On pace to add 2 more to current 2 (2018, 2022)* |
| **Pro Bowl Selections**   | 15 ✅ <br> (Holds Record)                  | 14 (projected) <br> *Consistent Pro Bowler (6 selections by 2023)* |
| **First-Team All-Pro**    | 3                       | 5 ✅ (projected) <br> *Could lead NFL in QB play a few more times (2 so far)* |
| **Career Passing Yards**  | 89,214 ✅ <br> (Holds Record)              | ≈80,000+ (projected) <br> *Maintains ~4,000+ yards/year into late 30s* |
| **Career Passing TDs**    | 649 ✅  <br> (Holds Record)                   | ≈600+ (projected) <br> *Continues 30+ TDs/year; potential to approach Brady’s total* |
| **Playoff Record**        | 35–13 ✅ <br> (Holds Record) | 30+ postseason wins (projected)  <br> *17–4 (as of 2025)* |
...
* Project Patrick Mahomes's career and final career statistics
